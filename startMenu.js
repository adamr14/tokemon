    ...
    switch(pageNumber){
        case 1:
            for (var i=0; i<3; i++){
                ...
                text("Pokemon and level up", 215, 185, 160, 20);
                text("your Pokemon", 215, 200, 160, 20);
                text("-Explore and fight the gym", 215, 225, 160, 20);
                text("when you think you're ready", 215, 240, 160, 20);
				text("-Heal your pokemon at the ", 215, 265, 160, 20);
                text("table in your house", 215, 280, 160, 20);
